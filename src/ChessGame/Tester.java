...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        ChessPlayer firstPlayer = new HumanChessPlayer("Mayank",getPieces(Color.BLACK) , chessBoard);
        ChessPlayer secondPlayer = new HumanChessPlayer("Test", getPieces(Color.WHITE), chessBoard);
